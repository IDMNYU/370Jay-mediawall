...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 678.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 602.0, 74.0, 22.0 ],
					"text" : "crossfader"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 486.0, 199.0, 57.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 305.0, 72.0, 24.0 ],
					"text" : "readfolder"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 549.0, 314.0, 24.0 ],
					"text" : "jit_gl_texture u374002272 u470002253"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 305.0, 202.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 105.0, 644.0, 33.0, 24.0 ],
					"text" : "!- 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 105.0, 598.0, 88.5, 28.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 153.0, 669.0, 40.0, 40.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 105.0, 669.0, 40.0, 40.0 ],
					"size" : 1.0
				}
...
,
					"patching_rect" : [ 56.0, 732.0, 116.0, 24.0 ],
...
,
					"patching_rect" : [ 84.0, 435.0, 757.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 453.0, 358.0, 364.0, 69.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 84.0, 358.0, 364.0, 69.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 56.0, 492.0, 148.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 287.0, 195.0, 80.0, 37.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 586.0, 125.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 516.0, 172.0, 90.0, 24.0 ],
					"text" : "counter 0 0 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 60.0, 773.0, 233.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 509.0, 293.0, 128.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 509.0, 331.0, 66.0, 24.0 ],
					"text" : "jit.cycle 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 436.0, 249.0, 165.0, 24.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 263.5, 343.5, 65.5, 343.5 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 194.5, 528.0, 847.75, 528.0, 847.75, 423.5, 831.5, 423.5 ],
					"source" : [ "obj-40", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 65.5, 543.5, 380.5, 543.5 ],
					"order" : 0,
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-39::obj-3" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-55::obj-3" : [ "live.toggle[1]", "live.toggle", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
